...
curl http://github.mtv.cloudera.com/raw/cdh/cdh/cdh6.0.x/tools/gerrit-unittest-setup.sh -o "$SETUP_FILE"
source "$SETUP_FILE"
...
grind -c ${DIR}/$SCRIPTS/env/grind.cfg test --java-version 8 --artifacts -r 2 \
    ...
    -e TestOpportunisticContainerAllocatorAMService \
    -e TestBlockStatsMXBean
