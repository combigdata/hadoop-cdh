...
function main() {
  ...
  wget -nc http://github.mtv.cloudera.com/raw/CDH/cdh/cdh6.1.0/gbn-m2-settings.xml
  export CDH_GBN=$(curl 'http://builddb.infra.cloudera.com:8080/resolvealias?alias=cdh6.1.0')
