...
public class Client {
  ...
  public boolean run() throws IOException, YarnException {
    ...
    setAMResourceCapability(appContext, resourceTypes);
    setContainerResources(resourceTypes);
